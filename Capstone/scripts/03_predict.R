##
## 03_predict.R
## Stupid Backoff next-word prediction over the unigram-quadgram tables built
## by 02_ngram_model.R. Sourced by both 04_evaluate.R and the Shiny app, so
## the prediction logic has a single source of truth.
##
